...
const projectsData: Array<IProject> = [
  {
    ...
    myContributions: [
      ...
      'Performed code reviews providing valuable feedback and insights to enhance code quality and ensure best practices.',
    ...
    languages: ['Typescript', 'HTML', 'CSS', 'C#', 'Bash', 'YAML', 'JSON'],
    other: [
      'MUI',
      'Vite',
      'eslint',
  ...
  },
  {
    ...
    other: ['Vite', 'GraphQL', 'eslint', 'Azure Devops', 'Chat GPT'],
  },
  {
    id: 5,
    association: 'Pack of 7',
    title: 'Microflows',
    description: 'Project management software suite.',
    myContributions: [
  ...
  },
  {
    ...
    description: 'Dashboard for the Commerzbank intranet.',
    myContributions: [
      'Implemented ESLint to the project to uphold coding standards, ensure consistent formatting, and proactively prevent coding errors.',
  ...
  },
  {
    ...
    languages: ['Typescript', 'HTML', 'CSS', 'CAML'],
  ...
  // },
  {
    ...
    association: 'Personal',
    title: 'Web3 Game',
    description: 'Rpg game utilizing blockchain technology.',
    myContributions: [
      'This is a work in progress and am currently mostly learning how to use Rust and the Bevy game engine.',
      'Implemented camera to view game.',
      'Generated terrain using algorithm to spawn mesh components in the game world.',
      'Implemented grid based player movement.',
      'Implemented tick system which serves as a clock in order for the system to know when to perform game events.',
      'Used Clickup to manage tasks.',
    ],
    techStack: ['Bevy'],
    languages: ['Rust'],
    other: ['Docker', 'Rancher', 'Clickup'],
  },
  {
    id: 1,
    association: 'Personal',
    title: 'Stock scraper',
    description: 'A web application for filtering stock market data.',
    myContributions: [
      'Added the ability to query data from Yahoo Finanace.',
      'Designed and build simple UI.',
      'Implemented the ability to filter stocks based on certain criteria.',
      'Implemented alogrithms to transform and perform calculations on data, facilitating the presentation of pertinent details.',
      'Established a CI/CD pipeline, streamlining the deployment process of the Angular application to a Heroku website.',
    ],
    techStack: ['Nodejs', 'Angular'],
    languages: ['Typescript', 'HTML', 'CSS'],
    other: ['Heroku'],
  },
];
